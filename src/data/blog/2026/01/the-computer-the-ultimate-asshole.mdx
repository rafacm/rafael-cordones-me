...
<figure>
  <Image src={harryAndSallyYesYesYes} alt="Restaurant scene from 'When Harry Met Sally'"/>
...
<figure>
  <Image src={harryAndSallyIllHaveShesHaving} alt="Restaurant scene from 'When Harry Met Sally'"/>
  <figcaption class="text-center">
...
<figure>
  <Image src={sysyphus} alt="Andrew Bird: Sysyphus"/>
  <figcaption class="text-center">
...
<figure>
  <Image src={hal9000} alt="HAL 9000 in '2001: Space Odyssey'"/>
    <figcaption class="text-center">
...
<figure>
  <Image src={nasaComputerProgrammers} alt="NASA's Mariner Missions: programmers at work"/>
  <figcaption class="text-center">
...
<figure>
  <Image src={sherlockHolmesDoYouNeedMeToElaborate} alt="Sherlock Holmes: now, do you need me to elaborate... or can we just crack on?"/>
  <figcaption class="text-center">
