...
import theSocialNetwork1 from '@/assets/images/blog/the-computer-the-ultimate-asshole/the-social-network-restaurant-scene-1.jpg';
...
<figure>
  <Image src={theSocialNetwork1} alt="Restaurant scene from movile 'The Social Network'"/>
