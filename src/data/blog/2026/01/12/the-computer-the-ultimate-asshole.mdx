...
Software development is most often portrayed as a creative craft of building new things, but the reality is frequently a battle against bugs, invisible bytes, and machines brutally intolerant of error. Inspired by [Clive Thompson](https://www.clivethompson.net/)’s book "[Coders](https://www.goodreads.com/book/show/40406806-coders)," I reflect on the daily reality of software development in a professional context and why the way computers "behave" to us shouldn't dictate how we behave towards other fellow humans.
...
## Software Developer's Daily Reality Bytes
...
## Sharing an Office with a Toxic Colleague
...
## The Ultimate Tool vs. The Ultimate Asshole
