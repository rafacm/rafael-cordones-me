...
ogImage: "@/assets/images/blog/appetizers-of-enterprise-integration-patterns-with-spring-integration/2013-04-20-12.03.59.jpg"
---

import { Image } from 'astro:assets';
import santJordi from '@/assets/images/blog/appetizers-of-enterprise-integration-patterns-with-spring-integration/2013-04-20-12.03.59.jpg';
import slides from '@/assets/images/blog/appetizers-of-enterprise-integration-patterns-with-spring-integration/slides.png';

<figure>
  <Image src={santJordi} alt="Sant Jordi"/>
...
<figure>
  <a href="https://speakerdeck.com/rafacm/appetizers-of-enterprise-integration-patterns-with-spring-integration"><Image src={slides} alt="Slides" class="mb-0"/></a>
    <figcaption class="text-center">
