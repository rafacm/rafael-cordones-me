...
ogImage: "@/assets/images/blog/deploying-camunda-bpm-process-applications-on-the-openshift-cloud/IMG_4231.jpg"
---

import { Image } from 'astro:assets';
import cloudAtDusk from '@/assets/images/blog/deploying-camunda-bpm-process-applications-on-the-openshift-cloud/IMG_4231.jpg';
import theJobAnnouncementOpenshift from '@/assets/images/blog/deploying-camunda-bpm-process-applications-on-the-openshift-cloud/thejobannouncement-rafacm-openshift.png';

<figure>
  <Image src={cloudAtDusk} alt="Cloud at dusk over the skyline of Alicante, Spain." />
...
In my humble opinion, the easiest way of doing fulfill these requirements, is to have a dedicated branch called "openshift" on which all the code/configuration related to camunda BPM on <strong>a given OpenShift deployment environment</strong> is kept.
...
* upstream: the canonical repository containing <a href="https://github.com/plexiti/the-job-announcement">The Job Announcement</a> project code
...
<figure>
  <Image src={theJobAnnouncementOpenshift} alt="The Job Announcement running on OpenShift" />
    <figcaption class="text-center">
