...
## Credits
1. This project is based on [Debbie O'Brien's](https://debbie.codes/) [Nuxt Content module](https://content.nuxtjs.org/) [demo project](https://github.com/nuxt-company/demo-blog-nuxt-content). See details in [Create a Blog with Nuxt Content](https://nuxtjs.org/blog/creating-blog-with-nuxt-content/).
